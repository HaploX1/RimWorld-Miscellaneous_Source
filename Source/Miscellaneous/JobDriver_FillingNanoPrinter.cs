...
{
    public class JobDriver_FillingNanoPrinter : JobDriver
    {
        private static TargetIndex IngredientInd = TargetIndex.A;
        private static TargetIndex BuildingInd = TargetIndex.B;
        private static TargetIndex IngredientPlaceCellInd = TargetIndex.C;

        public JobDriver_FillingNanoPrinter() { }
        ...
        private static Toil JumpToCollectNextIntoHands(Toil gotoGetTargetToil, TargetIndex ind)
        {
            ...
            toil.initAction = () =>
            {
                ...
                {
                    Log.Warning("JumpToCollectNextIntoHands run on " + actor + " who is not carrying something.");
                    return;
                }
