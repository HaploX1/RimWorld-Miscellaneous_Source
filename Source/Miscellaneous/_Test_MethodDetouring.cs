...
namespace CommunityCoreLibrary_Test
{
    ...
    public static class Detours
    {
        ...
        public static bool TryDetourFromTo(Type sourceType, Type targetType,
                                             string sourceMethodName, string targetMethodName,
                                             BindingFlags sourceBindingFlags = BindingFlags.Static | BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic,
                                             BindingFlags targetBindingFlags = BindingFlags.Static | BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic)
        {
            MethodInfo sourceMethodInfo = sourceType.GetMethod(sourceMethodName, BindingFlags.Instance | BindingFlags.Public);
            MethodInfo targetMethodInfo = targetType.GetMethod(targetMethodName, BindingFlags.Static | BindingFlags.NonPublic);

            return TryDetourFromTo(sourceMethodInfo, targetMethodInfo);
        }
