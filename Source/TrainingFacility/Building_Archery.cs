...
{
    public class Building_Archery : Building
    {

        public JoyGiverDef GetJoyGiverDef()
        {
            return DefDatabase<JoyGiverDef>.GetNamed("ShootSomeArrows");
        }
        public JobDef GetJobDef()
        {
            return DefDatabase<JobDef>.GetNamed("ArcheryShootArrows");
        }
        ...
        public override IEnumerable<FloatMenuOption> GetFloatMenuOptions(Pawn selPawn)
        {
            ...
            //if (attackVerb != null && attackVerb.verbProps != null && !attackVerb.verbProps.IsMeleeAttack)
            {
                ...
                if (standCell != IntVec3.Invalid)
                    yield return new FloatMenuOption("TrainingFacility_PracticeArchery".Translate(), action_PracticeShooting);
            }
            //else
            //{
